...
void sumAbsoluteDifferences(uint16_t * SAD, uint8x16_t * curr, uint8x16_t * prev, int offset) {
        ...
        */
        ...
        /* Compute SAD for identical block position in frame */
        uint16x8_t     sum = vpaddlq_u8(vabdq_u8(curr[0],  prev[0]));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[1],  prev[1])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[2],  prev[2])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[3],  prev[3])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[4],  prev[4])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[5],  prev[5])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[6],  prev[6])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[7],  prev[7])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[8],  prev[8])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[9],  prev[9])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[10], prev[10])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[11], prev[11])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[12], prev[12])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[13], prev[13])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[14], prev[14])));
        sum = vaddq_u16(sum, vpaddlq_u8(vabdq_u8(curr[15], prev[15])));
